        ...
        if(err) console.log(err);
            ...
            _user.save(function(err){
                ...
                let mailOptions = {
                    ...
                    html: '<style> .footer{text-shadow: 2px 2px; margin: 100px; font-size: 30px; font-weight: bold; } h1{font-family: "Bree Serif", serif;} .container{background: #eeeeee;width: 100%; text-align: center; height: 350px;} .inner{ margin: auto;width: 300px; padding:10px; background: #f5f5f5; height: 93%;} .message{font-size: 20px; font-weight: bold; font-family: "Bree Serif", serif; width: 70%; margin:auto; margin-bottom: 40px; padding: 5px; cursor: default;} .link{text-decoration: none; font-family: "Bree Serif", serif; border: 1px solid #fff; color: #fff; border-radius: 25px; padding: 15px; background: brown; } .name{text-transform:UPPERCASE}</style><table class="container"> <table class="inner"><h1>Password Reset Link</h1><p class="message">If you requested a password reset for <span class="name">'+_user.first_name+'</span>, click the link. If it was not you... ummm</p><a class="link" href="http://localhost:8000/password_reset/token/'+ _user.resettoken+'">Reset Password</a><table class="footer"><p>friendZone</p></table></table></table>'
                };
